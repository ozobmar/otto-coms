...
from otto_voice.config import Config, apply_cli_overrides, load_config
from otto_voice.processing.hardware import detect_hardware, recommend_settings
...
def main() -> None:
    ...
    logger.info("Log file: %s", log_dir / "otto-voice.log")
    ...
    # Run pipeline
    from otto_voice.pipeline import run_pipeline
